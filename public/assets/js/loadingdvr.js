! function(a, b) {
    ...
    function i(a) {
      ...
      b.settings = Object.assign({}, e, a || {}), b.id = n.instanceCount, g = b.settings.timeout, g = g && parseInt(g >= 0) && parseInt(g) <= Math.NEGATIVE_INFINITY ? parseInt(g) : e.timeout, b.timeout = g, b.settings.timeout = g, b.timer = null, i = document.createElement("div"), k = f[b.settings.type || "info"], l = h("content-" + b.settings.type || "info"), l += b.settings.showClose ? " " + h("content-with-close") : "", m = b.settings.content || "", o = f["close"], p = b.settings.showClose ? '<i class="wstoast-icon wstoast-icon-close">' + o + "</i>" : "", q = document.createElement("span"), b.settings.html ? q.innerHTML = m : q.innerText = m, i.innerHTML = '<div class="wstoast-content">            <div class="' + l + '">                <i class="wstoast-icon">' + k + "</i>" + q.outerHTML + p + "</div>		</div>", i.classList.add(h("item")), i.style.textAlign = b.settings.position, r = document.querySelector("." + c), r || (r = document.createElement("div"), r.classList.add(c), r.classList.add(h("wrapper")), r.classList.add(h("is-initialized")), document.body.appendChild(r)), r.appendChild(i), b.$wrapper = r, b.$elem = i, j(b, "opening"), b.settings.showClose && i.querySelector(".wstoast-icon-close").addEventListener("click", function() {
        b.close()
    ...
    function k(a) {
      var b = h("count"),
        c = a.$elem.querySelector('[class^="wstoast-content-"]'),
        d = c.querySelector("." + b);
    ...
    function m(a) {
      ...
      for (e in this.oMsgs)
        ...
        if (this.instanceCount++, g = {}, g.id = this.instanceCount, g.config = b, d = new i(a), d.id = this.instanceCount, d.count = "", g.inst = d, this.oMsgs[this.instanceCount] = g, h = this.oMsgs.length, j = this.maxNums, h > j)
          for (l = 0, m = this.oMsgs, l; h - j > l; l++) m[l] && m[l].inst.settings.autoClose && m[l].inst.close()
    ...
    return "function" != typeof Object.assign && (Object.assign = function(a) {
    ...
    }), b = "wstoast", c = a && a.WSTOAST_GLOBALS && a.WSTOAST_GLOBALS.NAMESPACE || b, d = {
      ...
      maxNums: 5,
      html: !1
    }, a && a.WSTOAST_GLOBALS && a.WSTOAST_GLOBALS.DEFAULTS), f = {
      info: '<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path d="M512 64q190.016 4.992 316.512 131.488T960 512q-4.992 190.016-131.488 316.512T512 960q-190.016-4.992-316.512-131.488T64 512q4.992-190.016 131.488-316.512T512 64zm67.008 275.008q26.016 0 43.008-15.488t16.992-41.504-16.992-41.504-42.496-15.488-42.496 15.488-16.992 41.504 16.992 41.504 42.016 15.488zm12 360q0-6.016.992-16T592 664l-52.992 60.992q-8 8.992-16.512 14.016T508 742.016q-8.992-4-8-14.016l88-276.992q4.992-28-8.992-48t-44.992-24q-35.008.992-76.512 29.504t-72.512 72.512v15.008q-.992 10.016 0 19.008l52.992-60.992q8-8.992 16.512-14.016T468 437.024q10.016 4.992 7.008 16l-87.008 276q-7.008 24.992 7.008 44.512T444 800.032q50.016-.992 84-28.992t63.008-72z" fill="#bd1aa7"/></svg>',
